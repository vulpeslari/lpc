    ...
    while game_loop:
        ...
        if lives_player_2 > 0 and lives_player_1 > 0:
            ...
            for i in range(len(blocks)):
                for block in blocks[i]:
                    if cont < 0:
                        if block[1] + block_height + 10 > player_2_y > block[1]:
                            if block[0] - block_width < player_2_x < block[0] + block_width + 20:
                                player_2_x += 10
                                if player_2_x >= 40 and player_2_y == 200:
                                    player_2_x = player_2_x

                                elif player_2_x < 680 and player_2_y == 1200:
                                    player_2_x = player_2_x

                                elif player_2_y >= 200 and player_2_x == 0:
                                    player_2_y = player_2_y

                                elif player_2_y < 1200 and player_2_x == 200:
                                    player_2_y = player_2_y

                                elif player_2_x < 680 and player_2_y > 0:
                                    player_2_y = player_2_y

                                elif player_2_y < 1200 and player_2_x > 40:
                                    player_2_y = player_2_y
                                    player_2_x = player_2_x

                                elif player_2_y > 200 and player_2_x > 40:
                                    player_2_x = player_2_x

                                elif player_2_y < 1200 and player_2_x < 680:
                                    player_2_x = player_2_x

                        if block[1] + block_height + 10 > player_1_y > block[1]:
                            if block[0] - block_width < player_1_x < block[0] + block_width + 20:
                                player_1_x -= 55
                                if player_1_x >= 40 and player_1_y == 200:
                                    player_1_x = player_1_x

                                elif player_2_x < 680 and player_2_y == 1200:
                                    player_1_x = player_1_x

                                elif player_2_y >= 200 and player_1_x == 0:
                                    player_1_y = player_1_y

                                elif player_2_y < 1200 and player_1_x == 200:
                                    player_1_y = player_1_y

                                elif player_2_x < 680 and player_2_y > 0:
                                    player_1_y = player_1_y

                                elif player_2_y < 1200 and player_1_x > 40:
                                    player_1_y = player_1_y
                                    player_1_x = player_1_x

                                elif player_2_y > 200 and player_1_x > 40:
                                    player_1_x = player_1_x

                                elif player_2_y < 1200 and player_1_x < 680:
                                    player_1_x = player_1_x
