...
def game_start():
    ...
    while game_loop:
        ...
        if lives_player_2 > 0 and lives_player_1 > 0:
            ...
            # ball 1 collision with the wall
            # right wall
            if ball_player_2_x > 1330 - border_width - ball_diameter:
                ball_player_2_x = 1330 - border_width - ball_diameter
                ball_player_2_dx *= -1
            ...
            # left wall
            elif ball_player_2_x <= border_width - 45:
                ball_player_2_x = border_width - 45
                ball_player_2_dx *= -1
                bounce_sound_effect.play()
                ball_hit = 1
                player_2_ball_hits += 1
            ...
            # ball 2 collision with the wall
            # right wall
            if ball_player_1_x > 1330 - border_width - ball_diameter:
                ball_player_1_x = 1330 - border_width - ball_diameter
                ball_player_1_dx *= -1
                bounce_sound_effect.play()
                ball_player_1_hit = 1
            ...
            # left wall
            elif ball_player_1_x <= border_width - 45:
                ball_player_1_x = border_width - 45
                ball_player_1_dx *= -1
                bounce_sound_effect.play()
                ball_player_1_hit = 1
                player_1_ball_hits += 1
